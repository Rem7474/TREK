...
const extractEnforced = vi.hoisted(() =>
  vi.fn<(input: EnforcedExtractInput) => Promise<Record<string, unknown> | null>>(async () => ({ receipts: [] })),
);
...
import type { EnforcedExtractInput } from '../../../../src/nest/llm-parse/router/ollama-format.client';
