...
describe('LLM_MODEL_CATALOGUE', () => {
  ...
  it('offers a model that reads images, which is the point of recommending this one', () => {
...
describe('modelReadsPhotos', () => {
  ...
  it('says nothing about an id it cannot place, which an explicit override is there to settle', () => {
    // Text-only: booking imports and PDF invoices, never a scanned page.
